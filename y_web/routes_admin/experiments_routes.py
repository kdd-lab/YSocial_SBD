...
def experiment_trends(exp_id):
    ...
    try:
        ...
        # Add debug info for HPC experiments to help troubleshoot plot issues
        if experiment.simulator_type == "HPC":
            result_data["debug_info"] = {
                ...
                "daily_compute_sample": {k: result_data['daily_compute'][k] for k in list(result_data['daily_compute'].keys())[:3]},
