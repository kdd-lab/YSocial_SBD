...
def test_polling_logic():
    ...
    assert poll_interval >= 10000, "Interval should be at least 10 seconds to avoid overload"
    ...
    print(f"✓ Expected calls in {duration}s: {int(expected_calls)} (initial + {int(expected_calls - 1)} polling)")
