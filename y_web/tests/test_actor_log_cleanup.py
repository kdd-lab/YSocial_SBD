...
def test_actor_log_cleanup_removes_last_two_lines():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert remaining_lines[-1].strip() == log_lines[2].strip(), "Last line should be 'Running simulation'"
...
def test_actor_log_cleanup_handles_file_with_less_than_two_lines():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert remaining_lines[0] == log_lines[0], "Original line should remain unchanged"
...
def test_actor_log_cleanup_handles_exactly_two_lines():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert len(remaining_lines) == 0, "Both lines should be removed, leaving empty file"
